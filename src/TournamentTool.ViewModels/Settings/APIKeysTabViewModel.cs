...
public class APIKeysTabViewModel : BaseViewModel, ISettingsTab
{
    ...
    public APIKeysTabViewModel(APIKeys apiKeys, IDispatcherService dispatcher, IDialogService dialogService) : base(dispatcher)
    {
        Name = "apikeys";
        _apiKeys = apiKeys;
    ...
    {
        var result = _dialogService.Show("Are you sure you want to clear your twitch access token from tournament tool?", "Clearing access token", MessageBoxButton.YesNo, MessageBoxImage.Warning);
