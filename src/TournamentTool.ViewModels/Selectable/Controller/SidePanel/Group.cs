...
public class Group<T> : BaseViewModel where T : IGroupableItem
{
    ...
    public Group(string groupName, int sortOrder, IDispatcherService dispatcher) : base(dispatcher)
    {
        GroupName = groupName;
    ...
    {
        Dispatcher.Invoke(() => Items.Insert(index, item));
    }
    public void RemoveItem(T item)
    {
        Dispatcher.Invoke(() => Items.Remove(item));
    }
    public void RemoveItemAt(int index)
    {
        Dispatcher.Invoke(() => Items.RemoveAt(index));
    }
}