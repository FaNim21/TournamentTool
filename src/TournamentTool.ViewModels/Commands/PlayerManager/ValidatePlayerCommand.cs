...
public class ValidatePlayerCommand : BaseCommand
{
    ...
    public ValidatePlayerCommand(PlayerManagerViewModel playerManager, IPresetSaver presetSaver, IWindowService windowService)
    {
    ...
    public override void Execute(object? parameter)
    {
        ...
        _player = player;
        _windowService.ShowLoading(ValidatePlayer);
    }
