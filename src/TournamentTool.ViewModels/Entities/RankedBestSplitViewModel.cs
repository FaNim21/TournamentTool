...
public class RankedBestSplitDataViewModel : BaseViewModel
{
    ...
    public RankedBestSplitDataViewModel(PrivRoomBestSplitData splitData, IDispatcherService dispatcher) : base(dispatcher)
    {
...
public class RankedBestSplitViewModel : BaseViewModel
{
    ...
    public RankedBestSplitViewModel(PrivRoomBestSplit bestSplit, IDispatcherService dispatcher) : base(dispatcher)
    {
