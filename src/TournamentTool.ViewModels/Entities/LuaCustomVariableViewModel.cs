...
public class LuaCustomVariableViewModel : BaseViewModel
{
    ...
    public LuaCustomVariableViewModel(LuaCustomVariable model, INotifyPresetModification notifyPresetModification, IDispatcherService dispatcher) : base(dispatcher)
    {
        _model = model;
