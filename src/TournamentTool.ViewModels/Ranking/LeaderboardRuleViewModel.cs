...
public class LeaderboardRuleViewModel : BaseViewModel
{
    ...
    public string? BrushBorderFocused { get; set; } = Consts.GrayColor;
    public string? BrushIsEnabledColor { get; set; }
    ...
    public bool IsFocused
    {
        ...
        set
        {
            ...
            Dispatcher.Invoke(() =>
            {
                BrushBorderFocused = value ? Consts.LightBlueColor : Consts.GrayColor;
    ...
    public LeaderboardRuleViewModel(LeaderboardRule rule, INotifyPresetModification notifyPresetModification, IDialogService dialogService, IDispatcherService dispatcher) : base(dispatcher)
    {
        _rule = rule;
        ...
        foreach (var subRule in rule.SubRules)
        {
            Dispatcher.Invoke(() =>
            {
                SubRules.Add(new LeaderboardSubRuleViewModel(subRule, this, notifyPresetModification, dialogService, dispatcher));
            });
        }
    ...
    {
        BrushIsEnabledColor = IsEnabled ? Consts.LiveColor : Consts.OfflineColor;
