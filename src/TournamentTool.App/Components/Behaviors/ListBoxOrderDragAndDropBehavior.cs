...
public class ListBoxOrderDragAndDropBehavior : BehaviorBase<ListBox>
{
    ...
    private void OnMouseDown(object sender, MouseButtonEventArgs e)
    {
        ...
        _draggedItem = UIHelper.GetItemUnderMouse<ListBoxItem>(AssociatedObject, e.GetPosition);
    }
    ...
    private void OnDrop(object sender, DragEventArgs e)
    {
        ...
        var targetItem = UIHelper.GetItemUnderMouse<ListBoxItem>(AssociatedObject, e.GetPosition);
